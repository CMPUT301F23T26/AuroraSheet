...
public class ItemManager {
    ...
    public void doFiltering() {
        ...
        if (Objects.nonNull(filterAfterDate)) {
            filterDatesBefore(filterAfterDate);
        }
        if (Objects.nonNull(filterDescriptionSubstring) && Objects.nonNull(filterDescriptionSubstringExcludeMode)) {
            filterItemsForDescriptionKeyword(filterDescriptionSubstring,filterDescriptionSubstringExcludeMode);
        }
        if (Objects.nonNull(filterMake) && Objects.nonNull(filterMakeExcludeMode)) {
